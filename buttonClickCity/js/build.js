...
function garageBuild() {
  ...
  //add one to the building variable
  buildings++;
  document.getElementById("city").innerHTML =
    "You have " + buildings + " buildings in your city!";
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='images/BuildingBlock1.png' alt='Garage'>";
}
...
function restBuild() {
  console.log("Restaurant is working!");
  buildings++;
  document.getElementById("city").innerHTML =
    "You have " + buildings + " buildings in your city!";
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='images/BuildingBlock3.png' alt='Restaurant'>";
}

function germaBuild() {
  console.log("Germa is working!");
  buildings++;
  document.getElementById("city").innerHTML =
    "You have " + buildings + " buildings in your city!";
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='images/littlegerma1.png' alt='Germa'>";
}
